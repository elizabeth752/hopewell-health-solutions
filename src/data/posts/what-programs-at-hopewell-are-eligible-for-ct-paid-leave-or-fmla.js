// Hand-authored post (structured `sections` model). Demonstrates the rich block format.
export default {
  slug: "what-programs-at-hopewell-are-eligible-for-ct-paid-leave-or-fmla",
  ...
  sections: [
    {
      ...
      h2: "Understanding CT Paid Leave and FMLA",
      blocks: [
        { p: "CT Paid Leave provides eligible workers in Connecticut income replacement when they must take time away from work for certain major life events or their own serious health condition. FMLA provides eligible employees up to 12 weeks of unpaid, job-protected leave for specified family or medical reasons, including the employee's own serious health condition." },
        { p: "The key in both cases is whether the health condition or treatment is serious enough to qualify, whether you are eligible based on employment and hours worked, and whether your employer is covered under FMLA or your job qualifies under CT Paid Leave rules." },
      ],
    },
    {
      id: "how-our-programs-fit",
      h2: "How Our Programs Fit",
      blocks: [
        { h3: "Intensive Outpatient Programs (IOPs)" },
    ...
    {
      id: "steps-to-explore-leave",
      h2: "Steps to Explore Leave for Treatment",
      blocks: [
        { ul: [
          "Talk with Hopewell's clinical team about your treatment plan and whether your clinician can certify a serious health condition.",
          "Notify your employer that you are requesting leave for your own serious health condition or for treatment of a condition that affects your ability to work.",
          "Determine whether you qualify for CT Paid Leave (check earnings, employer coverage, qualifying reason) and/or FMLA (check employer size, hours worked, job location) before you apply.",
          "Gather documentation from your provider supporting the necessity of your treatment plan, number of sessions, impact on job performance, and estimated timeframe.",
          "Keep your employer, your treatment team at Hopewell, and your leave coordinator in communication so that your return-to-work plan is clear and manageable.",
        ] },
      ],
    },
    {
  ...
  sources: [
    { text: "CT Paid Leave Authority — Covered employees & qualifying reasons", href: "https://ctpaidleave.org/" },
    { text: "U.S. Department of Labor — Family and Medical Leave Act (FMLA)", href: "https://www.dol.gov/agencies/whd/fmla" },
    { text: "U.S. DOL Fact Sheet #28A — Employee Protections under the FMLA", href: "https://www.dol.gov/agencies/whd/fact-sheets/28a-fmla-employee-protections" },
    { text: "Connecticut Department of Labor — Family & Medical Leave", href: "https://www.ctdol.state.ct.us/progsupt/fmla/fmla.htm" },
  ],
};
